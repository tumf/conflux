...
- [x] 1. native archive destination naming を dated 形式へ切り替える
...
- [x] 2. native archive の成功出力と archive 解決を dated 標準に揃える
...
- [x] 3. archive verification / TUI archived lookup の互換性を回帰させない
...
- [x] 4. dated archive naming の canonical spec delta と実装検証を完了する
