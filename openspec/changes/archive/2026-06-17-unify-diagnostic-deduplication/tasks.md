...
- [x] Add/modify spec delta under `openspec/changes/unify-diagnostic-deduplication/specs/parallel-execution/spec.md` and target the canonical `openspec/specs/parallel-execution/spec.md` requirement. (verification: not-testable - spec delta addition; evidence: source path `openspec/changes/unify-diagnostic-deduplication/specs/parallel-execution/spec.md`)
