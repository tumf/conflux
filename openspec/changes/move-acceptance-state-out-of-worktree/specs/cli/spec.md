...
Conflux 自身が resume / archive safety のために保持する acceptance state は、Git worktree 内の untracked/uncommitted artifact として dirty-worktree 判定や merge defer の原因になってはならない（MUST NOT）。
