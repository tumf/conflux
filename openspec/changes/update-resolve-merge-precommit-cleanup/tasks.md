...
- [x] 作業ツリーをクリーンにする: `Cargo.lock`, `openspec/changes/update-resolve-merge-precommit-cleanup/tasks.md`, `src/parallel/conflict.rs`, `src/parallel/tests/conflict.rs` の未コミット変更を解消して `git status --porcelain` を空にする
