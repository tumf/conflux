...
- [ ] Investigate blocker in openspec/changes/refactor-prune-agent-runner-legacy-paths/REJECTED.md and implement a non-rejection recovery path before rerunning apply
