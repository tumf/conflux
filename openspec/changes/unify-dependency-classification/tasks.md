...
- [x] Add spec delta under `openspec/changes/unify-dependency-classification/specs/parallel-execution/spec.md`. (verification: unit - `cflx openspec validate unify-dependency-classification --strict` passes)
