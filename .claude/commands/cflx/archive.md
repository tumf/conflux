...
category: Conflux
tags: [openspec, cflx, conflux, archive]
---
...
1. Determine the change ID to archive:
   ...
   - If context does not contain a change ID but the conversation context clearly indicates which change to archive, infer the change ID from context without asking.
