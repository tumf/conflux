...
## Summary
- 4225 nodes · 11771 edges · 132 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 4383 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (355): AcpClient, create_shared_active_commands(), check_task_progress(), archive_entry_exists(), ArchiveEventHandler, ArchiveLoopResult, ArchiveVerificationResult, build_archive_error_message() (+347 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (267): handle_start_processing_command(), handle_tui_command(), TuiCommandContext, all_completed_keeps_stopped_mode(), all_completed_preserves_error_mode(), all_completed_resets_blocked_and_queued_to_not_queued(), all_completed_transitions_to_select(), AppState (+259 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (173): AcpMessage, create_worktree(), delete_worktree(), merge_worktree(), BaseHTTPRequestHandler, branch_delete(), checkout(), get_logs() (+165 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (205): get_changed_files(), get_current_commit(), default_retry_patterns(), acceptance_verdict_grace_period(), commit_workspace_change(), create_test_config(), create_test_config_with(), execute_acceptance_in_workspace() (+197 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (168): delete_acceptance_state(), AcpContent, AcpElicitationParams, AcpError, AcpEvent, AcpPromptBlock, AcpUpdateParams, dispatch_jsonrpc_response() (+160 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (153): Colors, main(), OpenSpecManager, print_change_detail(), print_changes(), Extract change information from directory., Count completed and total tasks., Show detailed information about a change. (+145 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (130): AiCommandRunner, OutputLine, test_inactivity_timeout_retry(), test_inactivity_timeout_streaming_pipeline(), test_post_completion_cleanup_on_cancellation(), test_post_completion_cleanup_on_failure(), test_post_completion_cleanup_on_success(), test_shared_stagger_state() (+122 more)
...
Cohesion: 0.02
Nodes (103): get_workspace_revision(), ArchiveLoopHookContext, branch_exists(), check_git_repo(), generate_unique_branch_name(), get_conflict_files(), get_current_branch(), get_status() (+95 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (101): test_cleanup_guard_all_preserved_does_nothing(), test_cleanup_guard_auto_backend_treated_as_git(), test_cleanup_guard_commit_enables_cleanup(), test_cleanup_guard_commit_on_success(), test_cleanup_guard_creation(), test_cleanup_guard_drop_with_empty_workspaces_does_nothing(), test_cleanup_guard_drop_without_commit_preserves_workspaces(), test_cleanup_guard_git_backend() (+93 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (43): make_ai_runner(), test_archive_change_retries_until_verified(), ParallelExecutor, AutoResolveGuard, build_conflict_resolve_prompt(), build_sequential_merge_resolve_prompt(), detect_conflicts(), get_vcs_log_for_revisions() (+35 more)
...
Cohesion: 0.02
Nodes (44): check_git_available(), check_parallel_available(), CheckConflictsArgs, Cli, Commands, EvidenceMode, InitArgs, install_skills_legacy_error() (+36 more)
...
Cohesion: 0.05
Nodes (44): append_recovery_task_section(), cleanup_worktree(), execute_rejection_flow(), extract_rejected_reason(), handle_resume_apply_from_rejecting(), init_git_repo(), parse_rejection_review_output(), rejected_file_path() (+36 more)
...
- **Thin community `Community 67`** (2 nodes): `setScrollMetrics()`, `ChatMessageList.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (2 nodes): `useWebSocket.ts`, `useWebSocket()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (2 nodes): `utils.ts`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (2 nodes): `Configure sys.path so shared modules are importable from tests.`, `conftest.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (2 nodes): `Result<T, E>`, `.or_fail()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (2 nodes): `OutputLine`, `output.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (1 nodes): `tailwind.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (1 nodes): `vite.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (1 nodes): `eslint.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (1 nodes): `postcss.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (1 nodes): `App.persistence.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (1 nodes): `ProjectCard.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (1 nodes): `ElicitationDialog.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (1 nodes): `ProposalChangesList.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (1 nodes): `ChangeRow.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (1 nodes): `CloseSessionDialog.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (1 nodes): `ProposalSessionTabs.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (1 nodes): `Header.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (1 nodes): `WorktreesPanel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (1 nodes): `ProjectsPanel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (1 nodes): `ProposalSessionTabs.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (1 nodes): `ChatInput.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `OverviewDashboard.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `ProposalChat.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `types.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (1 nodes): `restClient.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (1 nodes): `Emit warning for invalid change directory.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (1 nodes): `lib.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (1 nodes): `queue_state.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (1 nodes): `events.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (1 nodes): `orchestration.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (1 nodes): `builder.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 101`** (1 nodes): `mod.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (1 nodes): `load.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (1 nodes): `mod.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (1 nodes): `mod.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (1 nodes): `refresh.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 110`** (1 nodes): `mod.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `ANSI color codes for terminal output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `Manage OpenSpec changes and specifications.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `Warn about obsolete OpenSpec artifacts that should be removed.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (1 nodes): `Return True when directory is a valid change (has proposal.md).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (1 nodes): `Emit warning for invalid change directory.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (1 nodes): `List all changes or specs.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 117`** (1 nodes): `Extract change information from directory.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (1 nodes): `Count completed and total tasks.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (1 nodes): `Show detailed information about a change.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (1 nodes): `Find the directory for a given change ID.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (1 nodes): `Validate a change or all changes.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (1 nodes): `Extract Change Type value from proposal.md content.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (1 nodes): `Validate a single change directory.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (1 nodes): `Validate tasks.md file format.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 125`** (1 nodes): `Validate spec delta files.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (1 nodes): `Emit archive-risk warnings for spec-only proposals with only MODIFIED/REMOVED de`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (1 nodes): `Archive a deployed change.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (1 nodes): `Simulate spec promotion and return errors without writing any files.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (1 nodes): `Update canonical specs from change deltas (simulation already passed).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (1 nodes): `Print changes or specs in a formatted way.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 131`** (1 nodes): `Print detailed change information.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
