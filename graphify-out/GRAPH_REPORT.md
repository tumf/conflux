# Graph Report - fix-dashboard-error-reselect-latency  (2026-04-29)

## Corpus Check
- 228 files · ~1,256,716 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4262 nodes · 11922 edges · 69 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 4436 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (364): AcpClient, create_shared_active_commands(), create_test_config(), test_auto_resolve_counter_is_thread_safe(), test_auto_resolve_counter_reduces_available_slots(), test_combined_manual_and_auto_resolve_slots(), test_multiple_auto_resolves_consume_multiple_slots(), InstallSkillsArgs (+356 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (204): ArchiveLoopHookContext, get_current_commit(), default_retry_patterns(), acceptance_verdict_grace_period(), commit_workspace_change(), create_test_config(), create_test_config_with(), execute_acceptance_in_workspace() (+196 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (165): execute_worktree_command(), main(), handle_start_processing_command(), handle_tui_command(), TuiCommandContext, all_completed_keeps_stopped_mode(), all_completed_preserves_error_mode(), all_completed_resets_blocked_and_queued_to_not_queued() (+157 more)
...
Cohesion: 0.02
Nodes (139): AcpMessage, delete_worktree(), merge_worktree(), build_remote_change_for_update(), emit_change_update_if_available(), get_logs(), get_project_history(), get_stats_overview() (+131 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (133): delete_acceptance_state(), branch_delete(), branch_exists(), check_git_repo(), checkout(), generate_unique_branch_name(), get_changed_files(), get_conflict_files() (+125 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (112): build_apply_prompt(), expand_apply_command(), test_archive_change_retries_until_verified(), ParallelExecutor, resolve_conflicts_with_retry(), run_post_apply_cleanup_review(), escape_for_single_quoted_context(), escape_shell_value() (+104 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (160): AcpContent, AcpElicitationParams, AcpError, AcpEvent, AcpPromptBlock, AcpUpdateParams, dispatch_jsonrpc_response(), dispatch_jsonrpc_response_ignores_non_u64_id_without_consuming_waiters() (+152 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (123): BaseHTTPRequestHandler, _blocks_equal(), delta_to_canonical(), merge_spec_delta(), parse_delta_sections(), Shared spec promotion engine for Conflux archive workflow.  Provides requirement, Split spec content into (preamble, [(normalized_key, full_block), ...]).      fu, Simulate spec promotion without writing any files.      Returns (result_content, (+115 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (90): Template, dispatch_event(), Orchestrator, post_archive_dispatch_event(), test_archive_path_structure(), test_archive_verification_logic(), test_filter_stalled_changes_skips_dependencies(), test_serial_shared_state_apply_count_and_iteration_increment() (+82 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (80): acceptance_test_streaming(), apply_change(), apply_change_streaming(), ApplyContext, ApplyResult, test_apply_context_new(), archive_change(), archive_change_streaming() (+72 more)
...
Cohesion: 0.05
Nodes (52): test_openspec_directory_structure(), AcceptanceAttempt, AcceptanceHistory, ApplyAttempt, ApplyHistory, ArchiveAttempt, ArchiveHistory, create_test_archive_attempt() (+44 more)
...
Cohesion: 0.06
Nodes (47): AiCommandRunner, OutputLine, test_inactivity_timeout_retry(), test_inactivity_timeout_streaming_pipeline(), test_post_completion_cleanup_on_cancellation(), test_post_completion_cleanup_on_failure(), test_post_completion_cleanup_on_success(), test_shared_stagger_state() (+39 more)
...
Cohesion: 0.05
Nodes (44): append_recovery_task_section(), cleanup_worktree(), execute_rejection_flow(), extract_rejected_reason(), handle_resume_apply_from_rejecting(), has_rejection_proposal(), parse_rejection_review_output(), rejected_file_path() (+36 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (37): check_task_progress(), commit(), detect_workspace_state(), get_latest_wip_snapshot(), has_apply_commit(), has_archive_files(), init_git_repo(), is_merged_to_base() (+29 more)

### Community 22 - "Community 22"
Cohesion: 0.08
Nodes (45): archive_entry_exists(), ArchiveEventHandler, ArchiveLoopResult, ArchiveVerificationResult, delete_change_directory(), ensure_archive_commit(), find_archive_entry_path(), get_task_progress() (+37 more)
...
- **Thin community `Community 34`** (17 nodes): `wsClient.ts`, `useProposalChat.test.ts`, `MockWebSocket`, `.close()`, `.constructor()`, `.emitClose()`, `.emitMessage()`, `.emitOpen()`, `WebSocketClient`, `.attemptReconnect()`, `.connect()`, `.constructor()`, `.disconnect()`, `.isConnected()`, `.notifyConnectionChange()`, `.on()`, `.startPingTimer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (6 nodes): `TuiCommand`, `TuiEventSink`, `.new()`, `.on_event()`, `.on_state_changed()`, `events.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (5 nodes): `dashboard_assets()`, `dashboard_favicon()`, `dashboard_icons()`, `dashboard_index()`, `dashboard.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `main()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 18`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `run_tui_loop()` connect `Community 6` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`?**
