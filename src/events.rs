...
pub enum ExecutionEvent {
    ...
    ///
    /// Still classified, reduced, and projected everywhere; no production path
    /// emits it since the TUI's cancel-stop projection stopped borrowing it as a
    /// "return to running" signal, so the reducer contract stays intact while
    /// dead-code analysis sees no constructor.
    #[allow(dead_code)]
