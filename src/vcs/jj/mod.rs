...
impl WorkspaceManager for JjWorkspaceManager {
    ...
    async fn find_existing_workspace(
        ...
        for old_ws in candidates {
            ...
            if let Err(e) = forget_result {
                warn!("Failed to forget workspace '{}': {}", old_ws.workspace_name, e);
            }
...
mod tests {
    ...
    fn test_extract_change_id_from_workspace_name_standard() {
        ...
        let result = JjWorkspaceManager::extract_change_id_from_workspace_name("ws-my-change-1234abcd");
    ...
    fn test_extract_change_id_from_workspace_name_with_dashes() {
        ...
        let result = JjWorkspaceManager::extract_change_id_from_workspace_name("ws-add-user-auth-abcdef12");
    ...
    fn test_extract_change_id_from_workspace_name_non_hex_suffix() {
        ...
        let result = JjWorkspaceManager::extract_change_id_from_workspace_name("ws-change-notahex!");
    ...
    fn test_extract_change_id_from_workspace_name_path_chars() {
        ...
        let result = JjWorkspaceManager::extract_change_id_from_workspace_name("ws-feature-login-fedcba98");
