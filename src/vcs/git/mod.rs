...
impl GitWorkspaceManager {
    ...
    async fn find_all_worktrees_for_change(
        ...
        let output = commands::run_git(&["worktree", "list", "--porcelain"], &self.repo_root).await?;
...
mod tests {
    ...
    fn test_extract_change_id_from_worktree_name_standard() {
        ...
        let result = GitWorkspaceManager::extract_change_id_from_worktree_name("ws-my-change-1234abcd");
    ...
    fn test_extract_change_id_from_worktree_name_with_dashes() {
        ...
        let result = GitWorkspaceManager::extract_change_id_from_worktree_name("ws-add-user-auth-abcdef12");
    ...
    fn test_extract_change_id_from_worktree_name_non_hex_suffix() {
        ...
        let result = GitWorkspaceManager::extract_change_id_from_worktree_name("ws-change-notahex!");
    ...
    fn test_extract_change_id_from_worktree_name_path_chars() {
        ...
        let result = GitWorkspaceManager::extract_change_id_from_worktree_name("ws-feature-login-fedcba98");
