...
#[openapi(
    ...
    paths(
        ...
        conflux::web::remote_control_api::reads::list_worktrees,
        conflux::web::remote_control_api::reads::get_worktree,
    ...
    components(
        schemas(
            ...
            conflux::web::remote_control_api::dto::ChangeTarget,
            conflux::web::remote_control_api::dto::WorktreeTarget,
            conflux::web::remote_control_api::dto::EmptyParams,
            ...
            conflux::web::remote_control_api::worktrees::WorktreeCapabilities,
            conflux::web::remote_control_api::worktrees::WorktreeConflict,
            conflux::web::remote_control_api::worktrees::WorktreeEligibility,
            conflux::web::remote_control_api::worktrees::WorktreeResource,
            conflux::web::remote_control_api::worktrees::WorktreeResponse,
            conflux::web::remote_control_api::worktrees::WorktreesResponse,
        )
    ),
    tags(
